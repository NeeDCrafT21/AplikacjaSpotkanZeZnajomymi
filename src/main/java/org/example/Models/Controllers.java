...
import org.example.Panels.Menu.MenuPanel.MenuPanelController;

public class Controllers {
    public static MainFrameController mainFrameController;
    public static AddFriendPanelController addFriendPanelController;
    public static CreateMeetingPanelController createMeetingPanelController;
    public static MenuPanelController menuPanelController;
