...
public class MapPanel extends JPanel implements ActionListener {
    ...
    MapPanel(OSMMap map, MarkerPanel markerPanel, MenuPanel menuPanel) {
        ...
        JPopupMenu addMarkerPopupMenu = new JPopupMenu();
        ...
        JPopupMenu editMarkerPopupMenu = new JPopupMenu();
        ...
        map.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(SwingUtilities.isRightMouseButton(e))
                    ...
                    if(clickedMarker.isCreated) editMarkerPopupMenu.show(map, e.getX(), e.getY());
                }
